...
impl ApiRequests {
    ...
    pub fn def_healthy() -> HttpReq<(), ()> {
        HttpReq::<(), ()> {
            ...
            path: "/".to_string(),
            security: HttpSecurity::Public,
            req_type: std::marker::PhantomData,
            resp_type: std::marker::PhantomData,
        }
    }

    pub fn def_login() -> HttpReq<LoginReq, LoginResp> {
        HttpReq::<LoginReq, LoginResp> {
    ...
    pub fn def_refresh() -> HttpReq<RefreshReq, RefreshResp> {
        HttpReq::<RefreshReq, RefreshResp> {
            method: HttpMethod::Post,
    ...
    pub fn def_new_message() -> HttpReq<NewMessageReq, MessageId> {
        HttpReq::<NewMessageReq, MessageId> {
            method: HttpMethod::Post,
            path: "/messages/new".to_string(),
            security: HttpSecurity::Token,
            req_type: std::marker::PhantomData,
            resp_type: std::marker::PhantomData,
        }
    }
    ...
    pub fn def_recent_messages() -> HttpReq<RecentMessagesReq, Paginated<Message>> {
        HttpReq::<RecentMessagesReq, Paginated<Message>> {
            method: HttpMethod::Get,
            path: "/messages/recent".to_string(),
            security: HttpSecurity::Token,
            req_type: std::marker::PhantomData,
            resp_type: std::marker::PhantomData,
        }
    ...
    pub fn def_create_user() -> HttpReq<UserDetails, AppUserId> {
        HttpReq::<UserDetails, AppUserId> {
            method: HttpMethod::Post,
            path: "/users/create".to_string(),
            security: HttpSecurity::TokenWithRole("admin".to_string()),
            req_type: std::marker::PhantomData,
            resp_type: std::marker::PhantomData,
        }
    }
    ...
    pub fn def_update_user() -> HttpReq<WithId<AppUserId, UserDetails>, Unit> {
        HttpReq::<WithId<AppUserId, UserDetails>, Unit> {
            method: HttpMethod::Post,
            path: "/users/update".to_string(),
            security: HttpSecurity::TokenWithRole("admin".to_string()),
            req_type: std::marker::PhantomData,
            resp_type: std::marker::PhantomData,
        }
    ...
    pub fn def_query_users() -> HttpReq<QueryUsersReq, Paginated<UserWithId>> {
        HttpReq::<QueryUsersReq, Paginated<UserWithId>> {
            method: HttpMethod::Get,
            path: "/users/query".to_string(),
            security: HttpSecurity::TokenWithRole("admin".to_string()),
            req_type: std::marker::PhantomData,
            resp_type: std::marker::PhantomData,
        }
