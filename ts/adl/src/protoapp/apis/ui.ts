...
export interface ApiRequests {
   ...
   * Signup a user
   */
  signup: common_http.HttpReq<SignupReq, SignupResp>;
  /**
...
export function makeApiRequests(
  ...
  return {
    ...
    signup: input.signup === undefined ? {method : "post", path : "/signup", security : {kind : "public"}, reqType : texprSignupReq(), respType : texprSignupResp()} : input.signup,
...
const SignupReq_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"SignupReq","type_":{"kind":"struct_","value":{"fields":[{"annotations":[],"default":{"kind":"nothing"},"name":"email","serializedName":"email","typeExpr":{"parameters":[],"typeRef":{"kind":"reference","value":{"moduleName":"common.strings","name":"StringNE"}}}},{"annotations":[],"default":{"kind":"nothing"},"name":"fullname","serializedName":"fullname","typeExpr":{"parameters":[],"typeRef":{"kind":"reference","value":{"moduleName":"common.strings","name":"StringNE"}}}},{"annotations":[],"default":{"kind":"nothing"},"name":"password","serializedName":"password","typeExpr":{"parameters":[],"typeRef":{"kind":"reference","value":{"moduleName":"common.strings","name":"Password"}}}}],"typeParams":[]}},"version":{"kind":"nothing"}},"moduleName":"protoapp.apis.ui"};

export const snSignupReq: ADL.ScopedName = {moduleName:"protoapp.apis.ui", name:"SignupReq"};

export function texprSignupReq(): ADL.ATypeExpr<SignupReq> {
  return {value : {typeRef : {kind: "reference", value : snSignupReq}, parameters : []}};
}

export type SignupResp = 'success' | 'email_already_exists';
export const valuesSignupResp : SignupResp[] = ['success', 'email_already_exists'];

const SignupResp_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"SignupResp","type_":{"kind":"union_","value":{"fields":[{"annotations":[],"default":{"kind":"nothing"},"name":"success","serializedName":"success","typeExpr":{"parameters":[],"typeRef":{"kind":"primitive","value":"Void"}}},{"annotations":[],"default":{"kind":"nothing"},"name":"email_already_exists","serializedName":"email_already_exists","typeExpr":{"parameters":[],"typeRef":{"kind":"primitive","value":"Void"}}}],"typeParams":[]}},"version":{"kind":"nothing"}},"moduleName":"protoapp.apis.ui"};

export const snSignupResp: ADL.ScopedName = {moduleName:"protoapp.apis.ui", name:"SignupResp"};

export function texprSignupResp(): ADL.ATypeExpr<SignupResp> {
  return {value : {typeRef : {kind: "reference", value : snSignupResp}, parameters : []}};
}
...
export const _AST_MAP: { [key: string]: ADL.ScopedDecl } = {
  ...
  "protoapp.apis.ui.SignupReq" : SignupReq_AST,
  "protoapp.apis.ui.SignupResp" : SignupResp_AST,
