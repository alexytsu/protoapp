...
export function isReady<T>(value: Loading<T>): value is { state: "ready"; value: T } {
...
export function lmap2<A1, A2, B>(ls: [Loading<A1>, Loading<A2>], f: (a1: A1, a2: A2) => B): Loading<B> {
  const [la1, la2] = ls;
...
export function lmap6<A1, A2, A3, A4, A5, A6, B>(
  ...
  return ready(f(la1.value, la2.value, la3.value, la4.value, la5.value, la6.value));
}
...
export function lmap7<A1, A2, A3, A4, A5, A6, A7, B>(
  ...
  return ready(f(la1.value, la2.value, la3.value, la4.value, la5.value, la6.value, la7.value));
}
